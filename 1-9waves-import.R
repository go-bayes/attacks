...
#read libraries, functions and data
...
# prefer packages if conflics conflicts
conflict_prefer("pool", "mice")
conflict_prefer("cbind", "base")

# for saving models -- for joseph bulbulia only -- won't work on your machine!
...
dt_raw  <- readRDS(here::here("data_raw", "dt_raw.rds"))
## wrangle data for imputation



test_temp <- dt_raw %>%
  dplyr::mutate(Gender3 = as.factor(if_else(
    GendAll == 0,
    "Female",
